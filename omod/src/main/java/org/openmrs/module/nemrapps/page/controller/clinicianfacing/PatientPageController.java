 ...
 */
package org.openmrs.module.nemrapps.page.controller.clinicianfacing;
...
public class PatientPageController {
	...
	public Object controller(@RequestParam("patientId") Patient patient, PageModel model,
		...
		// Create context model for overall actions(exclude the active visit from the context to make general actions independent of a visit)
		...
		List<Extension> secondColumnFragments = appFrameworkService
		        .getExtensionsForCurrentUser("patientDashboard.secondColumnFragments");
